  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-44 md:pb-28 px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/3 left-[15%] w-[350px] h-[350px] rounded-full bg-primary/[0.06] blur-[100px]" />
        <div className="absolute top-1/4 right-[10%] w-[400px] h-[400px] rounded-full bg-primary/[0.04] blur-[120px]" />
        ...
        >
          ...
          <rect width="1200" height="600" fill="url(#aboutGrid)" />
        </svg>
      </div>
